...
public class InputBank : MonoBehaviour
{
    ...
    [Header("Debug")]
    public float SwipeMag;
    public float SwirlTotalAngleSwirled;
    public float ShakeTurns;
    ...
    void Update()
    {
        ...
        CurrentGesture = LatestGesture != null? LatestGesture.ToString() : "none";
    }

    internal void ResetGestures()
    {
        for (int i = 0; i < _gestures.Count; i++)
        {
